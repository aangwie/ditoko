    ...
    <nav class="flex-1 px-2 md:px-4 py-6 space-y-1 overflow-y-auto">
        @php
            $navItems = [
                ...
                ['route' => 'admin.buyers.index', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', 'label' => 'Data Buyer', 'routeName' => 'admin.buyers.*'],
                ['route' => 'admin.settings.bank.index', 'icon' => 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', 'label' => 'Bank', 'routeName' => 'admin.settings.bank.*'],
