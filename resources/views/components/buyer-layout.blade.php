...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased" x-data="{ sidebarOpen: false }">
        <div class="min-h-screen bg-gray-100 flex">
            <!-- Sidebar -->
            <aside id="sidebar" class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-ditoko-navy text-white transform transition-transform duration-300 ease-in-out shadow-xl -translate-x-full lg:translate-x-0" :class="{ '-translate-x-full': !sidebarOpen, 'translate-x-0': sidebarOpen }">
